...
<html lang="en">
    ...
    <head>
        ...
        @@include("partials/title-meta.html", {"title": "Themify Icons"})
        ...
        <div id="layout-wrapper">
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    ...
                    @@include("partials/page-title.html", {"pagetitle": "Morvin", "subtitle":"Icons" ,"title": "Themify Icons"})
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="card-title-desc">Use <code>&lt;i class="ti-arrow-up"&gt;&lt;/i&gt;</code>.
                                            </p>
    
                                            <h5 class="text-center">Arrows Icons</h5>
                                            ...
                                            <h5 class="text-center mt-5">Web App Icons</h5>
                                            <div class="row icon-demo-content">
                                                <div class="col-xl-3 col-lg-4 col-sm-6">
                                            ...
                                            <h5 class="text-center mt-5">Control Icons</h5>
                                            ...
                                            <h5 class="text-center mt-5">Text Editor</h5>
                                            ...
                                            <h5 class="text-center mt-5">Layout Icons</h5>
                                            ...
                                            <h5 class="text-center mt-5">Brand Icons</h5>
