...
<html lang="en">
    ...
    <head>
        ...
        @@include("partials/title-meta.html", {"title": "General"})
        ...
        <div id="layout-wrapper">
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    ...
                    @@include("partials/page-title.html", {"pagetitle": "Morvin", "subtitle":"UI Elements" ,"title": "General"})
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex flex-wrap gap-3">
                                                ...
                                                <button type="button" class="btn btn-secondary waves-effect" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" data-bs-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
                                                    Popover on top
                                                </button>
                                                <!-- <button type="button" class="btn btn-secondary" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" data-bs-content="Top popover">
                                                    Popover on top
                                                  </button> -->
                                                <button type="button" class="btn btn-secondary waves-effect" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="right" data-bs-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
                                                    Popover on right
                                                </button>
                
                                                <button type="button" class="btn btn-secondary waves-effect" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="bottom"
                                                        data-bs-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
                                                    Popover on bottom
                                                </button>
                
                                                <button type="button" class="btn btn-secondary waves-effect" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="left" title="Popover Title" data-bs-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
                                                    Popover on left
                                                </button>
                
                                                <button type="button" class="btn btn-success waves-effect waves-light" data-bs-container="body" data-bs-toggle="popover" data-bs-trigger="focus" title="Dismissible popover" data-bs-content="And here's some amazing content. It's very engaging. Right?">Dismissible popover</button>
                                            </div>
                                        </div><!-- end cardbody -->
                                    </div><!-- end card -->
                                </div><!-- end col -->
                                ...
                                <div class="col-xl-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex flex-wrap gap-3" id="tooltip-container">
