...
<head>
    ...
    @@include("partials/title-meta.html", {"title": "Boxed"})
    ...
    <div id="layout-wrapper">
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                @@include("partials/page-title.html", {"pagetitle": "Morvin", "subtitle":"Layouts" ,"title":"Boxed"})
                                                ...
                                                <div class="dash-info-widget mt-4 mt-lg-0 py-4 px-3 rounded">
                                                    ...
                                                    <div class="media dash-main-border pb-2 mt-2">
                                                       ...
                                                       <div class="media-body ps-3">
                                                        ...
                                                        <p class="text-muted"> <a href="#" class="text-primary">Withdraw <i class="mdi mdi-arrow-right"></i></a>
                                                        </p>
                                                    ...
                                                    <div class="media mt-4 dash-main-border pb-2">
                                                        ...
                                                        <p class="text-muted"> <a href="#" class="text-primary">Pay <i class="mdi mdi-arrow-right"></i></a></p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="media mt-4">
                                                       ...
                                                       <div class="media-body ps-3">
                                                        ...
                                                        <p class="text-muted mb-0"> <a href="#" class="text-primary">View <i class="mdi mdi-arrow-right"></i></a></p>
                                                       </div>
                                                    </div>
                                                </div>
                                            </div>
