...
<html lang="en">
    ...
    <head>
        ...
        @@include("partials/title-meta.html", {"title": "Material Design"})
        ...
        <div id="layout-wrapper">
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    ...
                    @@include("partials/page-title.html", {"pagetitle": "Morvin", "subtitle":"Icons" ,"title": "Material Design"})
                            ...
                            <div class="row icons-demo-content">
                                <div class="col-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <h4 class="header-title">New Icons</h4>
                                            <p class="header-title-desc mb-2">Use <code>&lt;i class="mdi mdi-speedometer-slow"&gt;&lt;/i&gt;</code> <span class="badge bg-success">v 5.8.55</span>.</p>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <h4 class="header-title">Rotate</h4>
